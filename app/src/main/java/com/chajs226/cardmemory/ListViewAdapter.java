...
public class ListViewAdapter extends BaseAdapter {
  ...
  //      mSelectedItemsIds = new SparseBooleanArray();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView updtTextView = (TextView) convertView.findViewById(R.id.tvUpdt) ;
        TextView contentsTextView = (TextView) convertView.findViewById(R.id.tvContents) ;
        ...
        updtTextView.setText(listViewItem.getUpdt().toString());
